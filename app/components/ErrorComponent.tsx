    ...
    <div className="rounded-lg border border-red-200 bg-red-50 p-4">
      ...
      {isError && error.stack && (
        <div className="mt-4">
          ...
          <pre className="mt-2 overflow-auto rounded-sm bg-gray-100 p-3 font-mono text-xs text-gray-800">
            {error.stack}
          </pre>
        </div>
      )}
      ...
      {resetErrorBoundary && (
        <button
          ...
          className="mt-4 rounded-sm bg-red-600 px-4 py-2 text-white hover:bg-red-700 focus:outline-hidden focus:ring-2 focus:ring-red-500/50"
        >
          Try again
        </button>
      )}
