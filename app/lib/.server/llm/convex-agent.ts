...
||||||| parent of a2b78f6 (Make the agent more robust to invalid tool calls and remove streaming UI)
...
>>>>>>> a2b78f6 (Make the agent more robust to invalid tool calls and remove streaming UI)
